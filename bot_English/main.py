...
async def help(ctx):
  ...
  embed2.add_field(name="/demi-human", value="display real-time price of Demi-Human.", inline=False)
  embed2.add_field(name="/demi-human-history", value="display history price of Demi-Human.", inline=False)
  embed2.add_field(name="/demi-nft", value="search specific Demi-Human NFT by token id. option: `token_id`", inline=False)
...
async def Demi_Human_History(ctx):
  ...
  one_day_volume = str(float(round(data1['stats']['one_day_volume'],3)))#one_day_volume
  one_day_change = str(float(round(data1['stats']['one_day_change'],3)))
  one_day_sales = str(float(round(data1['stats']['one_day_sales'],3)))
  one_day_average_price = str(float(round(data1['stats']['one_day_average_price'],3)))
  seven_day_volume = str(float(round(data1['stats']['seven_day_volume'],3)))
  seven_day_change = str(float(round(data1['stats']['seven_day_change'],3)))
  seven_day_sales = str(float(round(data1['stats']['seven_day_sales'],3)))
  seven_day_average_price = str(float(round(data1['stats']['seven_day_average_price'],3)))
  thirty_day_volume = str(float(round(data1['stats']['thirty_day_volume'],3)))
  thirty_day_change = str(float(round(data1['stats']['thirty_day_change'],3)))
  thirty_day_sales = str(float(round(data1['stats']['thirty_day_sales'],3)))
  thirty_day_average_price = str(float(round(data1['stats']['thirty_day_average_price'],3)))
  ...
  if(one_day_volume != 0):
    ...
    embed.add_field(name="1 day sales quantity" , value=one_day_sales+" Demi Human NFT", inline=False)
    ...
    embed.add_field(name="7 day sales quantity" , value=seven_day_sales+" Demi Human NFT", inline=False)
    ...
    embed.add_field(name="30 day sales quantity" , value=thirty_day_sales+" Demi Human NFT", inline=False)
...
async def Demi_Human(ctx):
  ...
  if(total_volume != 0):
    ...
    embed.set_thumbnail(url="https://cdn.jsdelivr.net/gh/Xeift/image-hosting@main//1c0e140d3293a88391abaaa1e02f8e0e.png")
    embed.add_field(name="total supply" , value=total_supply+" Demi Human NFT", inline=False) 
    ...
    embed.add_field(name="total sales" , value=total_sales+" Demi Human NFT", inline=False)
...
async def project_history(ctx,project_name):
  ...
  one_day_volume = str(float(round(data1['stats']['one_day_volume'],3)))
  one_day_change = str(float(round(data1['stats']['one_day_change'],3)))
  one_day_sales = str(float(round(data1['stats']['one_day_sales'],3)))
  one_day_average_price = str(float(round(data1['stats']['one_day_average_price'],3)))
  seven_day_volume = str(float(round(data1['stats']['seven_day_volume'],3)))
