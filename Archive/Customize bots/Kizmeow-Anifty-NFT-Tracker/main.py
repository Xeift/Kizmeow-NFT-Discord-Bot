...
async def anifty_History(ctx):
  ...
  if(one_day_volume != 0):
    ...
    embed.add_field(name="1 day sales quantity" , value=one_day_sales+" Anifty NFT", inline=False)
...
async def Anifty(ctx):
  ...
  if(total_volume != 0):
    ...
    embed.set_thumbnail(url="https://cdn.jsdelivr.net/gh/Xeift/image-hosting@main//1c0e140d3293a88391abaaa1e02f8e0e.png")
    embed.add_field(name="total supply" , value=total_supply+" Anifty NFT", inline=False) 
    ...
    embed.add_field(name="total sales" , value=total_sales+" Anifty NFT", inline=False)
